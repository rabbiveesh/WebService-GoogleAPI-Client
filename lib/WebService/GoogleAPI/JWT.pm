...
$WebService::GoogleAPI::JWT::VERSION = '0.22';
...
sub _construct_claims {
  ...
  croak "Can't use both scopes and audience in the same token"
    if @scopes && $self->audience;
...
WebService::GoogleAPI::JWT - JWT for authorizing service accounts
