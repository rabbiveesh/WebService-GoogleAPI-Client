...
isa_ok my $jwt = WebService::GoogleAPI::JWT->new,
  ['WebService::GoogleAPI::JWT'], 'empty object creation';
...
for my $scopes (c('/a/scope', '/b/scope'), [qw+ /a/scope /b/scope +]) {
  ok $jwt = WebService::GoogleAPI::JWT->new(
    client_email => $client_email,
    issue_at     => '1429812717',
    scopes       => $scopes
    ),
    'created a token for ' . ref($scopes) . ' as scopes';
